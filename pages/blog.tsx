    ...
    return (
        <Layout>
            ...
            <div className="container inline-block">
                {session ? (<div className="text-base float-right mt-4 text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 lg:ml-2">
                     <Link href="./new">
                        <a>Create post</a>
                    </Link> 
                </div>) : (<div></div>)}
            ...
            <div className="w-full flex-col mx-auto justify-center items-center ">
                 {posts.map(
                    post => {
                        return (
                            <div className="bg-white border rounded w-1/2 mb-16 mx-80 py-8 px-12 flex flex-col  border  border-blue-200 text-justify justify-center leading-normal shadow hover:bg-gray-100 hover:shadow-md">
