...
const Layout = ({
  ...
  return (
    <div
      className={
        !home
          ? "bg-gradient-to-r from-purple-100 to-blue-100 flex flex-col width-screen h-full overflow-scroll"
          : "bg-gradient-to-r from-indigo-200 to-purple-200 flex flex-col width-screen h-screen overflow-scroll"
      }
    >
      <header>
        <Nav />
          ...
          <div className="flex w-full md:w-1/2 ">
            <div className="px-8">
              ...
              <div className="container justify-center inline-flex mt-8 space-x-4 ">
                ...
                <a href="https://www.linkedin.com/in/rushil-ramesh-2a8404209/">
                  <SocialIcon network="linkedin" />
                </a>
                <a href="https://github.com/rushilramesh">
