...
const Layout = ({children, loggedOut, home} : {children: React.ReactNode, loggedOut?: boolean, home?: boolean}) => {
    return (
        <div className={!home ? "flex flex-col width-screen h-screen" : "flex flex-col width-screen h-screen bg-scroll"}>
            ...
            <footer  className= {(home) ? " fixed bottom-0 bg-black border-t w-full border-gray-400 shadow text-gray-50 h-36" : "  bg-black border-t border-gray-400 shadow text-gray-50 "}>
