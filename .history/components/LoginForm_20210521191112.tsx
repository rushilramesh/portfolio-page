        ...
        return (
            <div className="h-screen flex justify-center items-start bg-gray-100">
                <form onSubmit={this.handleSubmit} className="p-10 bg-white rounded flex flex-col justify-center text-center mt-56">
                    ...
                    <div><input type="email" placeholder="username" name="username" className="mb-5 p-3 w-80 focus:border-purple-700 rounded border-2 outline-none" onChange={this.handleChange}/></div>
