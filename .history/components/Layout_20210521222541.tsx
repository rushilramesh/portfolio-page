...
const Layout = ({children, loggedIn, footer} : {children: React.ReactNode, loggedIn?: boolean, footer?: boolean}) => {
    return (
        <div className="flex flex-col width-screen h-screen">
            ...
            <footer  className= {footer ? " fixed bottom-0 bg-black border-t border-gray-400 shadow text-gray-50 " : " relative bottom-0 bg-black border-t border-gray-400 shadow text-gray-50 "}>
