...
const Layout = ({children, home, post} : {children: React.ReactNode, home?: boolean, post?: boolean}) => {
    return (
        <div className={! home ? ("bg-gradient-to-r from-indigo-200 to-blue-200 flex flex-col width-screen h-full") : ("flex flex-col width-screen h-screen")} >
            <header>
                <Nav />
            </header>
