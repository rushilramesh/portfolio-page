...
export default function Nav() {
   ...
   return (
      <nav id="header" className="w-full z-30 top-10 py-1 bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600 shadow-lg  mt-15">
         ...
         <div className="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
            <div className="auth flex space-x-4 items-center w-full md:w-full">
               ...
               <button className=" text-indigo-600 p-2 rounded border mr-4 hover:bg-gray-100 hover:text-indigo-700">
                  {session ? (
                        <button onClick={e => {
                           e.preventDefault()
                           signOut()
