...
const Layout = ({children, loggedIn, fixedfoot} : {children: React.ReactNode, loggedIn?: boolean, fixedfoot?: boolean}) => {
    return (
        <div className="flex flex-col width-screen h-screen">
            ...
            <footer  className= {(footer) ? " sticky bottom-0 bg-black border-t border-gray-400 shadow text-gray-50 " : " relative bottom-0 bg-black border-t border-gray-400 shadow text-gray-50 "}>
