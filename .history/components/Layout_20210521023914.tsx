...
const Layout = ({children, loggedIn} : {children: React.ReactNode, loggedIn?: boolean}) => {
    return (
        <div className="container flex flex-col m-0 width-screen height-screen">
            <Nav />
            <div className="container mx-auto text-center">
                <main>{children}</main>
            </div>
            <footer className="bg-black border-t border-gray-400 shadow  align-baseline text-gray-50">
