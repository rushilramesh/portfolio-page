...
export default function Footer() {
    return (
        <footer style={{ position: "fixed", bottom: 0, width:"100%" }} className="bg-black border-t border-gray-400 shadow  text-gray-50 h-40" >
            <div className="container max-w-4xl mx-auto flex py-8 space-y-4">
