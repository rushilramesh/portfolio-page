...
const Layout = ({children, home, } : {children: React.ReactNode, home?: boolean, }) => {
    return (
        <div className={! home ? ("bg-gradient-to-r from-indigo-100 to-blue-100 flex flex-col width-screen h-full") : ("bg-gradient-to-r from-indigo-200 to-purple-200 flex flex-col width-screen h-screen")} >
            <header>
                <Nav />
            </header>
