...
const Layout = ({children, loggedOut, home} : {children: React.ReactNode, loggedOut?: boolean, home?: boolean}) => {
    return (
        <div className={!home ? "flex flex-col width-screen h-screen" : "flex flex-col width-screen h-screen bg-scroll-main-background"}>
            <header>
                <Nav />
            </header>
            ...
            <footer  className= {(home) ? " fixed bottom-0 bg-black border-t w-full border-gray-400 shadow text-gray-50 " : "  bg-black border-t border-gray-400 shadow text-gray-50 "}>
                ...
                <div className="flex w-full md:w-7/12 ">
                    <div className="px-8">
                        ...
                        <p className="py-4 text-gray-50 text-sm">
                            Hello, Rushil here! I'm a first-year undergraduate student at NUS.
                            <br/>
