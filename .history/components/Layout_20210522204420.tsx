...
const Layout = ({children, loggedOut, fixedfoot} : {children: React.ReactNode, loggedOut?: boolean, fixedfoot?: boolean}) => {
    return (
        <div className="flex flex-col width-screen h-screen">
            ...
            <footer  className= {(fixedfoot) ? " sticky bottom-0 bg-black border-t border-gray-400 shadow text-gray-50 " : "  bg-black border-t border-gray-400 shadow text-gray-50 "}>
