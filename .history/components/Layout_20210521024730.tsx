...
const Layout = ({children, loggedIn} : {children: React.ReactNode, loggedIn?: boolean}) => {
    return (
        ...
        <footer className="bg-black border-t border-gray-400 shadow mb-16 text-gray-50 h-100" >
            <div style={{ position: "absolute", bottom: 0, width:"100%" }} className="container max-w-4xl mx-auto flex py-8 space-y-4ß">
