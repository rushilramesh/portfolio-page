...
const Layout = ({children, home, blog} : {children: React.ReactNode, home?: boolean, blog?: boolean}) => {
    return (
        <div className={!blog ? ("flex flex-col width-screen h-screen") : ("bg-gradient-to-r from-green-200 via-green-200 to-blue-200 bg-auto flex flex-col width-screen h-screen")} >
            <header>
                <Nav />
            </header>
