    ...
    return (
        <Layout>
            ...
            <div className="flex-row">
                ...
                <Link href="./new">
                    <a className="text-base self-start text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2">Create post</a>
                </Link> 
            </div>
