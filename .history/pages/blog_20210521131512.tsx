...
export default function Blog({ 
    ...
    return (
        <Layout>
            ...
            <br />
            <Link href="./new"><a className="text-base text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2">Create post</a></Link> 
