    ...
    return (
        <Layout>
            ...
            <div className="container flex-col">
                ...
                <div className="text-base  text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2">
                    <Link href="./new">
                        <a className="text-align-right">Create post</a>
                    </Link> 
                </div>
