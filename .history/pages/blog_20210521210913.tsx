                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            <div className="container items-center border  border-blue-100 flex-col mt-8">
                            <a>
                                <div className="bg-white border rounded w-full mb-16  py-8 flex flex-col items-center justify-center leading-normal shadow">
