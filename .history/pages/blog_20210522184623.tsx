                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            ...
                            <a>
                                <div className="bg-white border rounded w-8/12 mb- mx-48 py-8 flex flex-col items-center border  border-blue-200 justify-center leading-normal shadow hover:bg-gray-50 hover:shadow-md">
