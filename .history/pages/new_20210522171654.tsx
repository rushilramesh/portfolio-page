...
// const nb2lr = require('locutus/php/strings/nl2br')
...
const New = ({
    ...
    const setBodyToHtml = event => {
        setForm({
            ...form,
            [event.target.name]: event.target.value.map(content => matter.stringify(content)))
        })
    }

    const handleSubmit = event => {
        setBodyToHtml(form.body)
