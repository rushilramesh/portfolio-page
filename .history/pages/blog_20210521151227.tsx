                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            ...
                            <a className=" container flex-col rounded w-8/12 mb-16" >
                                
                                <div className="bg-white border rounded px-4 py-4 flex flex-col items-center justify-between leading-normal shadow">
