        ...
        <Layout>
            ...
            <div className="container inline-block">
                ...
                <div className="my-16 border-b border-gray-300">
                    <h1 className="text-4xl font font-extrabold text-center ">My Blog</h1>
                    <h2 className="text-gray-500 text-center mt-4 mb-8">A space for me to share my thoughts</h2>
                </div>
