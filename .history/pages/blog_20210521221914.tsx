    ...
    return (
        <Layout>
            ...
            <div className="container inline-block">
                <div className="text-base float-right mt-8 text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2">
                    <Link href="./new">
                        <a>Create post</a>
                    </Link> 
                </div>
                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            <div className="container items-center flex-col mx-24 mt-8">
                            <a>
                                <div className="bg-white border rounded w-10/12 mb-16  py-8 flex flex-col items-center border  border-blue-200 justify-center leading-normal shadow">
                                
                                    <div className="mt-3 md:mt-0 text-gray-700 mt-8 font-bold p-1 text-3xl mb-2">
                                        {post.title}
                                    </div>
                                
                                <div className="h-48 w-8/12 flex bg-cover text-justify overflow-hidden opacity-75"  >
                                    {post.body}
                                </div>
