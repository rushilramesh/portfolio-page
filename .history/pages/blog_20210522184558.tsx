                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            ...
                            <a>
                                <div className="bg-white border rounded w-8/12 mb-16 mx-48 py-8 flex flex-col items-center border  border-blue-200 justify-center leading-normal shadow hover:bg-gray-50 hover:shadow-md">
                                
                                    <div className="mt-3 md:mt-0 text-gray-700 mt-8 font-bold p-1 text-4xl mb-2">
                                        {post.title}
                                    </div>
                                
                                <div className="h-36 w-8/12 flex bg-cover text-center font-semibold text-lg overflow-hidden opacity-75"  >
                                    {post.description}
                                </div>
