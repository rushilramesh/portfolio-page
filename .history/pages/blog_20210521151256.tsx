                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            ...
                            <a className=" container flex-col" >
                                
                                <div className="bg-white border w-8/12 rounded mb-16 px-4 py-4 flex flex-col items-center justify-between leading-normal shadow">
