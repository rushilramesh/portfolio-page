...
export default function Blog({ 
    ...
    return (
        <Layout>
            ...
            <h1 className="conatiner text-6xl align-center font-bold text-center">My Blog</h1>
            <div className="flex">
                
                <Link href="./new">
                    <a className="text-base text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2">Create post</a>
                </Link> 
            </div>

            <div className="w-full flex-col  mx-auto justify-center items-center border-gray-200 border">
                 {posts.map(
                    post => {
                        return (
                        <Link href={`posts/${post._id}`} >
                        <a className="block rounded w-full self-center lg:flex mb-10" >
