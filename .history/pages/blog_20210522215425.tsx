    ...
    return (
        <Layout>
            ...
            <div className="container inline-block">
                <div className="text-base tracking-tighter float-right mt-4 text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 ml-4 lg:ml-2">
                    <Link href="./new">
                        <a>Create post</a>
                    </Link> 
                </div>
