...
export default function Blog({ 
    ...
    return (
        <Layout>
            ...
            <div className="w-full flex-col w-8/12 mx-auto justify-center items-center ">
                 {posts.map(
                    post => {
                        return (
                        <Link href={`posts/${post._id}`} >
                            <div className="">
                            <a className=" container border rounded border-blue-300 flex-col rounded w-8/12 mb-16" >
