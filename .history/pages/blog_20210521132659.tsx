...
export default function Blog({ 
    ...
    return (
        <Layout>
            ...
            <h1 className="text-6xl my-16 font-bold text-center">My Blog</h1>
            ...
            <div className="w-full flex-col  mx-auto justify-center items-center ">
                 {posts.map(
                    post => {
                        ...
                        <a className="flex-col rounded w-full mb-10" >
                            ...
                            <div className=" flex bg-cover text-justify overflow-hidden opacity-75"  >
                                {post.body.split(0, 200)}
                            </div>
