    ...
    return (
        <Layout>
            ...
            <div className="container inline-block">
                {person ? (<div className="text-base float-right mt-4 text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 lg:ml-2">
                     <Link href="./new">
                        <a>Create post</a>
                    </Link> 
                </div>) : (<div></div>)}
                                ...
                                <Link href={`posts/${post._id}`} >
                                    <a>
                                        <div className="mt-3 md:mt-0 text-gray-700  font-bold p-1 text-4xl mb-4">
                                            { person && (<Link href={`posts/${post._id}/edit`}>
