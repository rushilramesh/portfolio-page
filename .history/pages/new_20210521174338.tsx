                ...
                <div className="p-6 bg-white border-b text-justify border-gray-200">
                        <form method="POST">
                            ...
                            <div className="mb-8">
                                ...
                                <input type="text" className="shadow form-textarea mt-1 block border-2 border-gray-300 p-2 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-48" name="description" id="description" ></input>
                            </div>
