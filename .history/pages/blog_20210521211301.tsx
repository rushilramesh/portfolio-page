                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            <div className="container items-center flex-col ml-20 mr-20 mt-8">
                            <a>
                                <div className="bg-white border rounded w-full mb-16  py-8 flex flex-col items-center border  border-blue-200 justify-center leading-normal shadow">
