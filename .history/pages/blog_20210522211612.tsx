    ...
    return (
        <Layout>
            ...
            <div className="container inline-block">
                <div className="text-base tracking-tighter float-right mt-4 text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 mr-8 lg:ml-2">
                    <Link href="./new">
                        <a>Create post</a>
                    </Link> 
                </div>
                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            ...
                            <a>
                                <div className="bg-white border rounded w-1/2 mb-16 mx-64 py-8 px-12 flex flex-col  border  border-blue-200 text-justify justify-center leading-normal shadow hover:bg-gray-50 hover:shadow-md">
