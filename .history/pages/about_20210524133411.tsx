        ...
        <div className="container height-screen justify-center text-center mt-16 flex flex-col">
            ...
            <main className="flex flex-col sm:flex-row-reverse sm:m-12 shadow-2xl">
                <div className="w-full sm:max-w-sm p-8 bg-gradient-to-t from-red-200 via-red-200 to-yellow-200">
                    <Image src="/images/displayPhoto.jpeg" alt="Profile Picture" width={190} height={250} className="rounded-full mb-4"/>
                    <h1 className="text-center text-4xl font-semibold mt-8 mb-4">{user.name}</h1>
                ...
                <div className="w-full bg-gray-100 text-justify p-12">
                    <div>
                        <h2 className="font-bold text-2xl uppercase py-2 text-indigo-600 px-8">Profile</h2>
                        <p>
