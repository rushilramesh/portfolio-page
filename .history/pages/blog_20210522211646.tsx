                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            ...
                            <a>
                                <div className="bg-white border rounded w-1/2 mb-16 mx-72 py-8 px-12 flex flex-col  border  border-blue-200 text-justify justify-center leading-normal shadow hover:bg-gray-50 hover:shadow-md">
