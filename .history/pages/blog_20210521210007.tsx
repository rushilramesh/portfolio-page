...
export default function Blog({ 
    ...
    return (
        <Layout>
            ...
            <div className="text-base flex-col float-right text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2">
                <Link href="./new">
                    <a >Create post</a>
                </Link> 
            </div>
