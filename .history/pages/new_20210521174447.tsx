                ...
                <div className="p-6 bg-white border-b text-justify border-gray-200">
                        <form method="POST">
                            ...
                            <div className="mb-8">
                                ...
                                <textarea class="shadow form-textarea mt-1 block w-full border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-48"  placeholder="Textarea"></textarea>
                            </div>
