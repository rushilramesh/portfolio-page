    ...
    return (
        <Layout>
            ...
            <div className="container inline-block">
                ...
                <div className="my-12">
                    <h1 className="text-4xl font font-extrabold text-center my-8">My Blog</h1>
                    <h2 className="text-gray-500 text-center my-8">A space for me to share my thoughts</h2>
                </div>
