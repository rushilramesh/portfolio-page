        ...
        <Layout fixedfoot>
            ...
            <article>
                <div className="mt-12 block">
                    <button className=" realtive top-0 text-base float-right text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2">Delete</button>
