        ...
        <Layout>
            ...
            <article>
                <div className="mt-12 block h-screen">
                    ...
                    <br/>
                    <div className="container bg-gray-100 w-9/12 mx-40 flex-col border-b mb-4 bprder-gray-300">
                    ...
                    <div className=" w-7/12 mx-64 mt-8 block bg-gray-100 text-justify" dangerouslySetInnerHTML={{ __html: postData.content}} />
                </div>
            </article>
        </Layout>
