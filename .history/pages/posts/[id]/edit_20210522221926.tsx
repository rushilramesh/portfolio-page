                    ...
                    <div className="p-6 bg-white border-b text-justify border-gray-200">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="container flex-col mb-4">
                                ...
                                <input type="text" className="border-2 border-gray-300 p-2 w-full" name="description" value={form.description} placeholder="About the"id="description" onChange={handleChange}></input>
                            </div>
                            <div className="mb-8">
...
export const getStaticPaths : GetStaticPaths = async () => {
    ...
    const paths = posts.map => `/posts/$._id.toString()}/edit`)
