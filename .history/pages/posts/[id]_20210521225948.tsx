        ...
        <Layout fixedfoot>
            ...
            <article>
                <div className="mt-12 block h-screen">
                    <div className="text-blue-600 hover:text-black font-medium text-justify -top-4">
                        <button className=" relative text-base float-right text-blue-600 pt-4 md:pt-0 inline-block no-underline hover:text-black font-medium text-lg py-2  lg:-ml-2">Delete</button>
                        <Link href="../blog">
                                <a>← Back to blog</a>
                        </Link>
                    </div>
