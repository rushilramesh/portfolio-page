            ...
            <article>
                <div className="mt-12 block h-screen">
                    ...
                    <div className="container w-9/12 mx-40 flex-col border-b mb-4 bprder-gray-300">
                        ...
                        <div className="container inline-block items-center mt-3">
                            <img alt="" src="/images/displayPhoto.jpeg" className="h-10 w-10 self-center rounded-full mr-2 object-cover" />
                            <div className="items-left">
                                <p className="font-semibold text-gray-700 text-sm capitalize"> {postData.post.user.name} </p>
                                <a href="https://twitter.com/?lang=en" className="text-gray-600 text-xs">@rushil</a>
