                 ...
                 {posts.map(
                    post => {
                        ...
                        <Link href={`posts/${post._id}`} >
                            ...
                            <a>
                                <div className="bg-white border rounded w-10/12 mb-16 mx-24 py-8 flex flex-col items-center border  border-blue-200 justify-center leading-normal shadow hover:shadow-md">
