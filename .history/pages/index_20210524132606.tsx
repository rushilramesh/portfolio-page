      ...
      <Head>
        ...
        <div className="container mx-auto  flex flex-col items-center justify-center w-full mt-32 flex-1 px-20 text-center opacity-75" >
          ...
          <div className="flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full">
            <Link href="./about">
              <a className="p-6 mt-6 text-left border w-96 rounded-xl hover:bg-yellow-300 focus:text-blue-600">
            ...
            <Link href="./blog">
              <a className="p-6 mt-6 text-left border w-96 rounded-xl hover:bg-blue-300 focus:text-blue-600">
